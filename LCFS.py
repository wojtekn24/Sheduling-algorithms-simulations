#ALGORYTM LCFS(Last Come, FirstServed)dla zamkniętej puli zadań
#Oznacza to, że sortujemy procesy od końca w takiej kolejności jakiej sie pojawiły
def lcfs(arrival_time: list[int], burst_time: list[int]) -> None:
